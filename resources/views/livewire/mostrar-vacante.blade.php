<div class="p-10">
    ...
    <div class="md:grid md:grid-cols-6 gap-4">
        <div class="md:col-span-2">
            <img src="{{ asset('storage/vacantes/' . $vacante->imagen)}}" alt="{{'Imagen de' . $vacante->titulo}}">
        </div>
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar a esta vacante? <a class="font-bold text-orange-600" href="{{ route('register') }}">Obten una cuenta y aplica a esta, y a otras vacantes </a>
            </p>
        </div>
    @endguest
